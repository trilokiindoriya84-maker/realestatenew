...
import { Clock, Eye, CheckCircle, XCircle, Loader2 } from 'lucide-react';
...
export default function PendingPropertiesPage() {
  ...
  const fetchPendingProperties = async () => {
    try {
      setLoading(true);
      const response = await api.get(`/admin/properties?status=${filter}`);
  ...
  return (
    <div className="p-8">
      <div className="mb-8">
        ...
        <p className="text-gray-600 mt-2">Properties awaiting verification and approval</p>
      </div>
        ...
        <div className="border-b border-gray-200">
          <nav className="flex -mb-px">
            <button
              ...
              className={`px-6 py-4 border-b-2 font-medium text-sm transition ${
                filter === 'pending'
