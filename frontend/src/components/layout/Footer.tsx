        ...
        <footer className="bg-slate-900 text-white py-12">
            <div className="container mx-auto px-4">
                <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                    <div>
                        ...
                        <p className="text-slate-300 text-sm">
                            The most trusted marketplace for buying and selling land, houses, and farms.
                        </p>
                    </div>
                    <div>
                        ...
                        <ul className="space-y-2 text-sm text-slate-300">
                            ...
                            <li><a href="#" className="hover:text-blue-400 transition-colors">Sell Property</a></li>
                ...
                <div className="mt-12 pt-8 border-t border-slate-700 text-center text-sm text-slate-400">
                    © {new Date().getFullYear()} Profeild. All rights reserved.
                </div>
            </div>
        </footer>
    );
